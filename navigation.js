            ...
            <ul class="nav-menu align-to-right">
                ...
                <li><a href="#">ABOUT US</a>
                    <ul class="nav-dropdown">
                        <li><a href="aboutsl.html">ABOUT SRILANKA</a></li>
                        <li><a href="about-us.html">ABOUT VTSL</a></li>
                    </ul>
                </li>
                <li><a href="#">TOURS</a>
                    <ul class="nav-dropdown">
                ...
                <li><a href="#">SERVICES</a>
                    <ul class="nav-dropdown">
                        <li><a href="accomadations.html">ACCOMADATION</a></li>
                        <li><a href="services.html">AIRPORT DROPS AND PICKUPS</a></li>
                    </ul>
                </li>
